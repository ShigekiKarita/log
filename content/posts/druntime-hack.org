...
私は雑にPRしてしまいましたが，一度Bugzillaを見て報告されていないか見ましょう．なければ新たに再現コードを貼って登録するだけで良いようです．誰かが二度修正するのを防げますし，PRタイトルやcommit logで "Fix Issue XXXX" と残すと自動でchangelogに反映されて，管理者や開発者の皆さんの手間が減るそうです．PRタイトルだとmergeされたときのcommit messageで反映されるっぽいです．
